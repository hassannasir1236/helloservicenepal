...
<script type="text/javascript">
    ...
    async function buildHTML(val) {
        ...
        html.push( val.userName);
        html.push(val.driverName);
        ...
        action = action + '<a id="' + val.id + '" name="carModel-delete" class="delete-btn" href="javascript:void(0)"><i class="fa fa-trash"></i></a>';
        <?php }?>
        action = action + '</span>';
        html.push(action);
        }
