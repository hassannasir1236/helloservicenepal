                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive m-t-10">
                                ...
                                <table id="sectionTable" class="display nowrap table table-hover table-striped table-bordered table table-striped"
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th>{{trans('lang.section_position')}}</th>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        async function getListData(val) {
            ...
            var position = (val.position !== undefined && val.position !== null) ? val.position : '-';
            ...
            if (checkDeletePermission) {
                ...
                html = html + '<a id="' + val.id + '" name="section-delete" class="delete-btn" href="javascript:void(0)"><i class="fa fa-trash"></i></a>';
