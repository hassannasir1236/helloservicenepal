...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var sectionsRef = database.collection("sections");

        function setNextPosition() {
            sectionsRef.orderBy("position", "desc").limit(1).get().then((querySnapshot) => {
                let nextPosition = 1; 

                if (!querySnapshot.empty) {
                    querySnapshot.forEach((doc) => {
                        let lastPosition = doc.data().position;
        ...
        $(".save-setting-btn").click(function () {
            ...
            if (name == '') {
                ...
                showError("{{trans('lang.enter_valid_position')}}");
            } else {
