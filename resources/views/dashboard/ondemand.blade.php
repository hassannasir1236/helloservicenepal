...
@section('content')
    ...
    <div id="main-wrapper" class="page-wrapper" style="min-height: 207px;">
        ...
        <div class="row cat-slider mb-4 mt-3 d-flex justify-content-around" id="sections">
                ...
                <div class="card-body">
                    ...
                    <div class="row business-analytics_list">
                        ...
                        <div class="col-sm-6 col-lg-3 mb-3">
                            <div class="card-box" onclick="location.href='{!! url('providerpayments') !!}'">
                        ...
                        <div class="col-sm-6 col-lg-3 mb-3">
                            <div class="card-box" onclick="location.href='{!! url('ondemand-bookings') !!}'">
                        ...
                        <div class="col-sm-6 col-lg-3 mb-3">
                            <div class="card-box" onclick="location.href='{!! url('ondemand-services') !!}'">
                        ...
                        <div class="col-sm-6 col-lg-3 mb-3">
                            <div class="card-box" onclick="location.href='{!! url('ondemand-workers') !!}'">
                        ...
                        <div class="col-sm-6 col-lg-3 mb-3">
                            <div class="card-box" onclick="location.href='{!! url('providers') !!}'">
                                <h5>{{trans('lang.dashboard_total_providers')}}</h5>
                                <h2 id="provider_count"></h2>
...
@section('scripts')
   ...
   async function getListData(val) {
            ...
            var count = 1;
                ...
                html = html + '<td data-url="' + provider_route + '" class="redirecttopage"><span class="fa fa-edit"></span></td>';
                html = html + '</tr>';
                count++;
            return html;
        }
