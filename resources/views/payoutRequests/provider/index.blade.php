...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-5 align-self-center">
            ...
            <h3 class="text-themecolor providerTitle">{{trans('lang.payout_request')}}</h3>
...
<script type="text/javascript">
    ...
    async function buildHTML(val) {
        ...
        if (id == "") {
            ...
            html.push('<td><span data-url="' + route_url + '" class="provider_' + val.vendorID + ' redirecttopage">'+val.title+'</span></td>');
