            ...
            appHomeBanners.get().then(async function (snapshots) {
                ...
                if (Array.isArray(data.banners) && data.banners.length > 0) {
                    ...
                    data.banners.forEach((photo) => {
                        photocount++;
                        banners_html = banners_html + '<span class="image-item" id="photo_' + photocount + '"><span class="remove-btn" data-id="' + photocount + '" data-img="' + photo + '" data-status="old"><i class="fa fa-remove"></i></span><img width="100px" id="" height="auto" src="' + photo + '"></span>';
                    })
                ...
                return function (e) {
                    ...
                    uploadTask.on('state_changed', function (snapshot) {
                        ...
                        uploadTask.snapshot.ref.getDownloadURL().then(function (downloadURL) {
                            ...
                            photo = filePayload;
                            photocount++;
                            let banner_html = '<span class="image-item" id="photo_' + photocount + '"><span class="remove-btn" data-id="' + photocount + '" data-img="' + photo + '" data-status="new"><i class="fa fa-remove"></i></span><img width="100px" id="" height="auto" src="' + photo + '"></span>';
