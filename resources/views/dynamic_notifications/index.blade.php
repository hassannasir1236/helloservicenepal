...
<script type="text/javascript">
    ...
    function buildHTML(val) {
        ...
        var number = [];
            ...
            html.push('<span class="action-btn"><i class="text-dark fs-12 fa-solid fa fa-info" data-toggle="tooltip" title="' + val.title + '" aria-describedby="tippy-3"></i><a href="' + route1 + '"><i class="fa fa-edit"></i></a></span>');
